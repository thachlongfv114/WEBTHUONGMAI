<%@ Page Title="Thông Tin" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ThongTin.aspx.cs" Inherits="BooksShopOnline.BookDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            <asp:FormView ID="bookDetail" runat="server"
        ItemType="BooksShopOnline.Models.Sport" SelectMethod ="GetDetails"
